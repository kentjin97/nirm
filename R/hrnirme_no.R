...
#' 
#' @export
hnirme_no <- function(dataset, nschool, nmax, nitem, ndim = 2, ncount,
                  niter = 30000, nburn = 5000, nthin = 5, nprint = 100, 
                  jump_beta = 0.2, jump_theta = 1.0, jump_w = 0.05,
  ...
  if((niter - nburn) %% nthin == 0){
    output = hrnirmenocpp(dataset, nschool, nmax, nitem, ndim, ncount, 
